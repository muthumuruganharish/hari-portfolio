...
const projects = [
  ...
  },
  {
    ...
    description: 'Secure full-stack authentication using JWT and bcrypt, with protected routes and middleware-based authorization.',
    image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=80',
    tags: ['MongoDB', 'Express', 'React', 'Node.js'],
    features: ['JWT Authentication', 'bcrypt Password Hashing', 'Protected Routes'],
    github: 'https://github.com/muthumuruganharish/mern-auth-system',
    demo: 'https://github.com/muthumuruganharish/mern-auth-system',
  },
  {
    title: 'Student Doubt / Q&A Platform',
    description: 'A student doubt and Q&A platform with CRUD operations, role-based access control, and optimized MongoDB queries for fast responses.',
    image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&auto=format&fit=crop&q=80',
    tags: ['MongoDB', 'Express', 'React', 'Node.js'],
    features: ['Role-Based Access', 'CRUD Interactions', 'React Hooks State Management'],
    github: 'https://github.com/muthumuruganharish/student-doubt-platform',
    demo: 'https://github.com/muthumuruganharish/student-doubt-platform',
  },
];
